...
jQuery.extend({	
 ImpromptuIncrement: 0,
	...
	prompt: function(m,o){
		o = jQuery.extend({ ImpromptuIncrement: ++jQuery.ImpromptuIncrement },jQuery.ImpromptuDefaults,o);
		...
		var msgbox = '<div class="'+ o.prefix +'box" id="'+ o.prefix+ o.ImpromptuIncrement +'box">';		
		if(o.useiframe && ((jQuery.browser.msie && jQuery('object, applet').length > 0) || ie6))//if you want to use the iframe uncomment these 3 lines
			msgbox += '<iframe src="javascript:;" class="'+ o.prefix +'fade" id="'+ o.prefix + o.ImpromptuIncrement +'fade"></iframe>';
		else{ 
			if(ie6) $('select').css('visibility','hidden');
			msgbox +='<div class="'+ o.prefix +'fade" id="'+ o.prefix + o.ImpromptuIncrement +'fade"></div>';
		}	
		msgbox += '<div class="'+ o.prefix +'" id="'+ o.prefix + o.ImpromptuIncrement +'"><div class="'+ o.prefix +'container"><div class="'+ o.prefix +'close">X</div><div class="'+ o.prefix +'message">'+ m +'</div><div class="'+ o.prefix +'buttons" id="'+ o.prefix + o.ImpromptuIncrement +'buttons">';
		jQuery.each(o.buttons,function(k,v){ msgbox += '<button name="'+ o.prefix +'button'+ k +'" id="'+ o.prefix + o.ImpromptuIncrement +'button'+ k +'" value="'+ v +'">'+ k +'</button>'}) ;
		msgbox += '</div></div></div></div>';
		
		var jqib =b.append(msgbox).children('#'+ o.prefix + o.ImpromptuIncrement +'box');
		var jqi = jqib.children('#'+ o.prefix + o.ImpromptuIncrement);
		var jqif = jqib.children('#'+ o.prefix + o.ImpromptuIncrement +'fade');
		...
		var stylePrompt = function(){
			jqif.css({ zIndex: o.zIndex+Math.pow(o.ImpromptuIncrement,2), display: "none", opacity: o.opacity });
			jqi.css({ zIndex: o.zIndex+Math.pow(o.ImpromptuIncrement,2)+1, display: "none" });
		}
		...
		//Events
		jQuery('#'+ o.prefix + o.ImpromptuIncrement +'buttons').children('button').click(function(){ 
		...
		jqi.find('#'+ o.prefix + o.ImpromptuIncrement +'buttons button:eq('+ o.focus +')').focus();//focus the default button
		return jqib;
	}	
});