...
// IRC formatting
define('NOFORMAT', chr(15));
define('WHITE', chr(3) . "00");
define('BLACK', chr(3) . "01");
define('BLUE', chr(3) . "02");
define('GREEN', chr(3) . "09");
define('RED', chr(3) . "04");
define('BROWN', chr(3) . "05");
define('PURPLE', chr(3) . "06");
define('OLIVE', chr(3) . "07");
define('YELLOW', chr(3) . "08");
define('LTGREEN', chr(3) . "09");
define('TEAL', chr(3) . "10");
define('AQUA', chr(3) . "11");
define('LTBLUE', chr(3) . "12");
define('PINK', chr(3) . "13");
define('GREY', chr(3) . "14");
define('LTGREY', chr(3) . "15");
